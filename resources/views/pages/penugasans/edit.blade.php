...
<?php
    $pageTitle = "Edit Penugasans"; //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("penugasans/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-pemberi_tugas_id-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $selected = ( $value == $data['pemberi_tugas_id'] ? 'selected' : null );
                                            ?>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-penerima_tugas_id-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $value = $option->value;
                                                $label = $option->label ?? $value;
                                                $selected = ( $value == $data['penerima_tugas_id'] ? 'selected' : null );
                                            ?>
                                            <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                            <?php echo $label; ?>
                                            </option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-uraian_tugas-holder" class=" ">
                                            <textarea placeholder="Enter Uraian Tugas" id="ctrl-uraian_tugas" data-field="uraian_tugas"  required="" rows="5" name="uraian_tugas" class=" form-control"><?php  echo $data['uraian_tugas']; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-uraian_hasil-holder" class=" ">
                                            <textarea placeholder="Enter Uraian Hasil" id="ctrl-uraian_hasil" data-field="uraian_hasil"  required="" rows="5" name="uraian_hasil" class=" form-control"><?php  echo $data['uraian_hasil']; ?></textarea>
                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-lampiran-holder" class=" ">
                                            <input id="ctrl-lampiran" data-field="lampiran"  value="<?php  echo $data['lampiran']; ?>" type="text" placeholder="Enter Lampiran"  required="" name="lampiran"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
