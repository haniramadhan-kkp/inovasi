...
<?php
    $pageTitle = "Edit Users"; //set dynamic page title
?>
@extends($layout)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-jabatan-holder" class=" ">
                                            <input id="ctrl-jabatan" data-field="jabatan"  value="<?php  echo $data['jabatan']; ?>" type="text" placeholder="Enter Jabatan"  required="" name="jabatan"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-foto-holder" class=" ">
                                            <input id="ctrl-foto" data-field="foto"  value="<?php  echo $data['foto']; ?>" type="text" placeholder="Enter Foto"  required="" name="foto"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
