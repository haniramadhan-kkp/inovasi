...
<?php
    ...
    $pageTitle = "Notulensiroles"; //set dynamic page title
?>
@extends($layout)
        ...
        <div class="row ">
            <div class="col-md-12 comp-grid " >
                ...
                <div  class=" page-content" >
                    <div id="notulensiroles-list-records">
                        <div class="row gutter-lg ">
                            <div class="col">
                                <div id="page-main-content" class="table-responsive">
                                    <?php Html::page_bread_crumb("/notulensiroles/", $field_name, $field_value); ?>
                                    <table class="table table-hover table-striped table-sm text-left">
                                        ...
                                        <tbody class="page-data">
                                            ...
                                            <td class="td-id">
                                                <a href="<?php print_link("notulensiroles/view/$data[id]") ?>"><?php echo $data['id']; ?></a>
                                            </td>
            ...
            <div class="col-12">
                <div class=" ">
                    <div id="notulensiroles-detail-page" class="master-detail-page"></div>
                </div>
            </div>
            <?php } ?>
        </div>
