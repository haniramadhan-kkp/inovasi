...
<?php
    $pageTitle = "Edit Realisasis"; //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("realisasis/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-akun_id-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $selected = ( $value == $data['akun_id'] ? 'selected' : null );
                                            ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-keterangan-holder" class=" ">
                                            <textarea placeholder="Enter Keterangan" id="ctrl-keterangan" data-field="keterangan"  required="" rows="5" name="keterangan" class=" form-control"><?php  echo $data['keterangan']; ?></textarea>
                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-bukti_bayar-holder" class=" ">
                                            <input id="ctrl-bukti_bayar" data-field="bukti_bayar"  value="<?php  echo $data['bukti_bayar']; ?>" type="text" placeholder="Enter Bukti Bayar"  required="" name="bukti_bayar"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-jumlah-holder" class=" ">
                                            <input id="ctrl-jumlah" data-field="jumlah"  value="<?php  echo $data['jumlah']; ?>" type="text" placeholder="Enter Jumlah"  required="" name="jumlah"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
