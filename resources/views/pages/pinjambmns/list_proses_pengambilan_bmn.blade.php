        ...
        <div class="row ">
            <div class="col-md-12 comp-grid " >
                ...
                <div  class=" page-content" >
                    <div id="pinjambmns-list_proses_pengambilan_bmn-records">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/pinjambmns/list_proses_pengambilan_bmn", $field_name, $field_value); ?>
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-foto_pengambilan" > Action</th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <td class="td-foto_pengembalian"><strong><?php echo $data['foto_pengembalian']; ?></strong></td>
                                ...
                                <td class="td-btn">
                                    <div class="dropdown" >
                                        ...
                                        <ul class="dropdown-menu">
                                            <?php if($can_edit){ ?>
                                            <a class="dropdown-item "   href="<?php print_link("pinjambmns/proses_pengambilan_bmn/$rec_id"); ?>" >
                                            <i class="material-icons ">compare_arrows</i> Proses
                                        </a>
                                        <?php } ?>
                                        <?php if($can_view){ ?>
