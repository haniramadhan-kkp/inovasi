            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="pinjambmns-ajukan_pinjam_bmn-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('pinjambmns.ajukan_pinjam_bmn_store') }}" method="post">
                            @csrf
                            <div>
