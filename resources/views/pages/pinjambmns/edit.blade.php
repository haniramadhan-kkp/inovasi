            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("pinjambmns/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-peminjam_id-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $selected = ( $value == $data['peminjam_id'] ? 'selected' : null );
                                            ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-atas_nama-holder" class=" ">
                                            <input id="ctrl-atas_nama" data-field="atas_nama"  value="<?php  echo $data['atas_nama']; ?>" type="text" placeholder="Enter Atas Nama"  required="" name="atas_nama"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-bmn_dipinjam-holder" class=" ">
                                            <textarea placeholder="Enter Bmn Dipinjam" id="ctrl-bmn_dipinjam" data-field="bmn_dipinjam"  required="" rows="5" name="bmn_dipinjam" class=" form-control"><?php  echo $data['bmn_dipinjam']; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-keperluan-holder" class=" ">
                                            <textarea placeholder="Enter Keperluan" id="ctrl-keperluan" data-field="keperluan"  required="" rows="5" name="keperluan" class=" form-control"><?php  echo $data['keperluan']; ?></textarea>
                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-catatan-holder" class=" ">
                                            <textarea placeholder="Enter Catatan" id="ctrl-catatan" data-field="catatan"  required="" rows="5" name="catatan" class=" form-control"><?php  echo $data['catatan']; ?></textarea>
                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-surat_peminjaman-holder" class=" ">
                                            <input id="ctrl-surat_peminjaman" data-field="surat_peminjaman"  value="<?php  echo $data['surat_peminjaman']; ?>" type="text" placeholder="Enter Surat Peminjaman"  required="" name="surat_peminjaman"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-foto_pengembalian-holder" class=" ">
                                            <input id="ctrl-foto_pengembalian" data-field="foto_pengembalian"  value="<?php  echo $data['foto_pengembalian']; ?>" type="text" placeholder="Enter Foto Pengembalian"  required="" name="foto_pengembalian"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-statuspinjambmn_id-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $value = $option->value;
                                                $label = $option->label ?? $value;
                                                $selected = ( $value == $data['statuspinjambmn_id'] ? 'selected' : null );
                                            ?>
                                            <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                            <?php echo $label; ?>
                                            </option>
